...
# local imports
from ps.plone.hosting.content.domain import IDomain
from ps.plone.hosting.testing import INTEGRATION_TESTING


CT = 'ps.plone.hosting.domain'


class DomainIntegrationTestCase(unittest.TestCase):
    """Test Case for the 'ps.plone.hosting.domain' content type."""
    ...
    def test_adding(self):
        ...
        self.assertTrue(IDomain.providedBy(self.ct))

    def test_schema(self):
        """Validate the correct schema."""
        fti = queryUtility(IDexterityFTI, name=CT)
        schema = fti.lookupSchema()
        self.assertEqual(IDomain, schema)
    ...
    def test_factory(self):
        ...
        self.assertTrue(IDomain.providedBy(new_object))
