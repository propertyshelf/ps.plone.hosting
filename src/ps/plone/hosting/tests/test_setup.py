# -*- coding: utf-8 -*-
"""Test Setup of ps.plone.hosting."""
...
# local imports
from ps.plone.hosting.config import PROJECTNAME
from ps.plone.hosting.testing import INTEGRATION_TESTING


class TestSetup(unittest.TestCase):
    """Validate setup process for ps.plone.hosting."""
    ...
    def test_addon_layer(self):
        ...
        self.assertIn('IPloneHostingLayer', layers)
...
class TestUninstall(unittest.TestCase):
    """Validate uninstall process for ps.plone.hosting."""
    ...
    def test_addon_layer_removed(self):
        ...
        layers = [l.getName() for l in registered_layers()]
        self.assertNotIn('IPloneHostingLayer', layers)
